...
router.get('/department', protect, authorize('faculty', 'admin', 'dept_head'), getDepartmentAchievements);
router.get('/all', protect, authorize('admin'), getAll);
router.put('/:id/verify', protect, authorize('faculty', 'admin', 'dept_head'), verify);
